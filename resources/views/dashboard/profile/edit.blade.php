    ...
    <div class="profile-wrapper relative py-[24px] ps-[24px] md:ps-[222px]">
			<label for="profile_image">
				@if (auth()->user()->authenticatable->profile_image)
					<img src="{{ asset('uploads/users/' . auth()->user()->authenticatable->profile_image) }}" alt="Profile Image" class="edit-profile-preview-img brightness-50 hover:brightness-100 duration-200 hidden md:inline-block rounded-circle w-[158px] h-[158px] absolute top-[-79px] left-[32px]"/>
				@else
					<img src="{{ asset('assets/img/avatars/1.png') }}" alt="Profile Image" class="edit-profile-preview-img brightness-50 hover:brightness-100 duration-200 hidden md:inline-block rounded-circle w-[158px] h-[158px] absolute top-[-79px] left-[32px]"/>
				@endif
				<svg class="duration-200 hover:scale-110 w-10 h-10 absolute -top-5 left-24 cursor-pointer" viewBox="0 0 718 650" fill="none" xmlns="http://www.w3.org/2000/svg">
