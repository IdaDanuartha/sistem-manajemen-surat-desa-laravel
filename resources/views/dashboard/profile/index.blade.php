        ...
        <div class="row">
            ...
            @if(!auth()->user()->isAdmin())
                ...
                <div class="col-md-6 col-12 mb-4 flex flex-col">
                    ...
                    <input type="text" class="input-crud" value="{{ auth()->user()->authenticatable->gender->label() ?? auth()->user()->authenticatable->citizent->gender->label() }}" readonly />
                </div>
                <div class="col-md-6 col-12 mb-4 flex flex-col">
                    <label class="text-second">Golongan Darah</label>
                    <input type="text" class="input-crud" value="{{ auth()->user()->authenticatable->blood_group->label() ?? auth()->user()->authenticatable->citizent->blood_group->label() }}" readonly />
                </div>
                <div class="col-md-6 col-12 mb-4 flex flex-col">
                    <label class="text-second">Agama</label>
                    <input type="text" class="input-crud" value="{{ auth()->user()->authenticatable->religion->label() ?? auth()->user()->authenticatable->citizent->religion->label() }}" readonly />
                </div>
                <div class="col-md-6 col-12 mb-4 flex flex-col">
                    <label class="text-second">Status Pernikahan</label>
                    <input type="text" class="input-crud" value="{{ auth()->user()->authenticatable->marital_status->label() ?? auth()->user()->authenticatable->citizent->marital_status->label() }}" readonly />
                </div>
            @endif
            <div class="col-12">
