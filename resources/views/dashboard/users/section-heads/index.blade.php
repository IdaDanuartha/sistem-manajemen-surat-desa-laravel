        ...
        <div class="flex justify-between items-center gap-3">
            <div class="input-wrapper flex gap-2 items-center">
                ...
                <input type="search" class="searchInputTable w-full focus:ring-0 focus:outline-none"
                    placeholder="Cari data kasi ...">
            </div>
            <div class="flex">
                <a href="{{ route('section-heads.create') }}"
                        ...
                        <tr class="table-body">
                            ...
                            <td>
                                <div class="flex gap-2 items-center">
                                    ...
                                    <a href="{{ route('section-heads.show', $item->id) }}" class="icon-table icon-detail">
                                    ...
                                    <a href="{{ route('section-heads.edit', $item->id) }}" class="icon-table icon-edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 16 16" fill="none">
