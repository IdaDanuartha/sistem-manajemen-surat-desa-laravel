	...
	<div class="table-wrapper mt-[20px] input-teacher">
		<form class="grid grid-cols-12 gap-4">						
			<div class="col-span-12 md:col-span-6 flex flex-col">
                ...
                <input type="text" disabled class="input-crud" id="name" value="{{ $sectionHead->name }}">
            </div>
            <div class="col-span-12 md:col-span-6 flex flex-col">
                <label for="employee_number" class="text-second mb-2">NIP</label>
                <input type="text" disabled class="input-crud" id="employee_number" value="{{ $sectionHead->employee_number }}">
            </div>
            <div class="col-span-12 md:col-span-6 flex flex-col">
                <label for="position" class="text-second mb-2">Jabatan</label>
                <input type="text" disabled class="input-crud" id="position" value="{{ $sectionHead->position }}">
            </div>
            <div class="col-span-12 md:col-span-6 flex flex-col">
            ...
            <div class="col-span-12 flex flex-col">
                ...
                <label class="switch">
                    <input type="checkbox" disabled name="user[status]" @checked($sectionHead->user->status->value == 1 ? 'on' : '')>
			...
			<div class="col-span-12 flex items-center gap-3 mt-2">				
				<a href="{{ route('section-heads.index') }}" class="button btn-second text-white" type="reset">Kembali</a>
			</div>
		</form>
	</div>
@endsection
