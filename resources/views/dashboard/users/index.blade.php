    ...
    <div class="table-wrapper mt-[20px]">
        <div class="flex justify-between items-center gap-3">
            <div class="input-wrapper flex gap-2 items-center">
                ...
                <input type="search" class="searchInputTable w-full focus:ring-0 focus:outline-none" placeholder="Cari data admin ...">
            </div>
            <div class="flex">
                    ...
                    <tr class="table-body">
                        ...
                        <td>
                            <div class="flex gap-2 items-center">
                                ...
                                <a href="{{ route('admins.show', $item->id) }}"  class="icon-table icon-detail">
