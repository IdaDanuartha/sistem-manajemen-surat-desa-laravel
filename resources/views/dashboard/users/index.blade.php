    ...
    <div class="table-wrapper mt-[20px]">
        <div class="flex justify-between items-center gap-3">
            <div class="input-wrapper flex gap-2 items-center">
                ...
                <input type="search" class="searchInputTable w-full focus:ring-0 focus:outline-none" placeholder="Cari pengguna ...">
            </div>
            <div class="flex">
                ...
                @forelse($users as $item)
                    <tr class="table-body">
                        ...
                        <td class="lg:table-cell">
                            @if ($item->villageHead)
                                Kepala Kelurahan
                            @elseif ($item->environmentalHead)
                                Kepala Lingkungan
                            @elseif ($item->sectionHead)
                                Kepala Seksi
                            @else
                                Warga
                            @endif                             
                        ...
                        <td>
                            <div class="flex gap-2 items-center">
                                ...
                                <a href="{{ route('users.show', $item->id) }}"  class="icon-table icon-detail">
