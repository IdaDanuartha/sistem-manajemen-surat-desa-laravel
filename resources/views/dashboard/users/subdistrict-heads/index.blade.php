        ...
        <div class="flex justify-between items-center gap-3">
            <div class="input-wrapper flex gap-2 items-center">
                ...
                <input type="search" class="searchInputTable w-full focus:ring-0 focus:outline-none"
                    placeholder="Cari data camat ...">
            </div>
            @if ($users->count() == 0)
                <div class="flex">
                    <a href="{{ route('subdistrict-heads.create') }}"
                        ...
                        <tr class="table-body">
                            ...
                            <td>
                                <div class="flex gap-2 items-center">
                                    ...
                                    <a href="{{ route('subdistrict-heads.show', $item->id) }}"
                                    ...
                                    <a href="{{ route('subdistrict-heads.edit', $item->id) }}"
