...
@section('main')
	...
	<div class="table-wrapper mt-[20px] input-teacher">
		<form action="{{ route('users.update', $user->id) }}" method="post" enctype="multipart/form-data" class="grid grid-cols-12 gap-4">
			@csrf
			@method('PUT')			
        ...
        @enderror
			...
			<div class="col-span-12 flex flex-col">
				...
				<label class="switch">
					<input type="checkbox" name="user[status]" @checked($user->user->status->value == 1 ? 'on' : '')>
			...
			<div class="col-span-12 flex flex-col">
				...
				<label for="profile_image" class="d-block mb-3">
					@if ($user->profile_image)
						<img src="{{ asset('uploads/users/' . $user->profile_image) }}" class="edit-citizent-preview-img border" width="300" alt="">
					@else
