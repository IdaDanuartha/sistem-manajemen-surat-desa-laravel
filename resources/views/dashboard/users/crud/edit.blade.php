        ...
        @enderror
			...
			<div class="col-span-12 md:col-span-6 flex flex-col">
				...
				@foreach (App\Enums\Gender::labels() as $key => $value)
					<option value="{{ $key+1 }}" class="capitalize" @selected($citizent->gender->value == $key+1)>{{ $value }}</option>
				@endforeach
				</select>
				@error('gender')
					<div class="text-danger mt-1">{{ $message }}</div>
			...
			<div class="col-span-12 md:col-span-6 flex flex-col">
				...
				@foreach (App\Enums\BloodGroup::labels() as $key => $value)
					<option value="{{ $key+1 }}" class="capitalize" @selected($citizent->blood_group->value == $key+1)>{{ $value }}</option>
				@endforeach
				</select>
				@error('blood_group')
					<div class="text-danger mt-1">{{ $message }}</div>
			...
			<div class="col-span-12 md:col-span-6 flex flex-col">
				...
				@foreach (App\Enums\Religion::labels() as $key => $value)
					<option value="{{ $key+1 }}" class="capitalize" @selected($citizent->religion->value == $key+1)>{{ $value }}</option>
				@endforeach
				</select>
				@error('religion')
					<div class="text-danger mt-1">{{ $message }}</div>
			...
			<div class="col-span-12 md:col-span-6 flex flex-col">
				...
				@foreach (App\Enums\MaritalStatus::labels() as $key => $value)
					<option value="{{ $key+1 }}" class="capitalize" @selected($citizent->marital_status->value == $key+1)>{{ $value }}</option>
				@endforeach
				</select>
