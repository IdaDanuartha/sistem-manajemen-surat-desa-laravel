	...
	<div class="table-wrapper mt-[20px] input-teacher">
        ...
        @enderror
			...
			<div class="col-span-12 flex flex-col">
				...
				<label class="switch">
					<input type="checkbox" name="user[status]" @checked($citizent->status->value == 1 ? 'on' : '')>
			...
			<div class="col-span-12 flex flex-col">
				...
				<label for="profile_image" class="d-block mb-3">
					@if ($citizent->profile_image)
						<img src="{{ asset('uploads/users/' . $citizent->profile_image) }}" class="edit-citizent-preview-img border" width="300" alt="">
					@else
