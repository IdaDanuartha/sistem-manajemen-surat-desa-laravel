...
<div class="py-14 pt-2">
    <div class="px-9 py-8 dashbaord-banner">
		<p class="text-sm text-white">Hi, Aditya Prayatna as Admin</p>
		<h4 class="text-3xl text-white font-semibold max-w-[400px]">
	...
	<div class="grid lg:grid-cols-4 mt-[20px] md:grid-cols-2 grid-cols-1 gap-8">
		...
		<div class="card-dashboard flex justify-between items-start">
            <div class="">
                <p class="mb-0 uppercase text-sm font-medium desc">Total Surat Diterima</p>
