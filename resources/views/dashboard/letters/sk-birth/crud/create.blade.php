    ...
    <div class="table-wrapper mt-[20px] input-teacher">
        <form action="{{ route('letters.sk-birth.store') }}" method="post" class="grid grid-cols-12 gap-4"
            ...
            <div class="col-span-12 md:col-span-6 flex flex-col">
                ...
                <input type="text" class="input-crud" name="sk[reference_number]" id="reference_number" placeholder="Masukkan Nomor Surat..." required />
            ...
            <div class="col-span-12 md:col-span-6 flex flex-col">
                ...
                <input type="text" class="input-crud" name="sk[cover_letter_number]" id="cover_letter_number" placeholder="Masukkan Nomor SP Kaling..." required />
