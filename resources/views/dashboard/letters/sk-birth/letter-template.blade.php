    ...
    <div class="container">
        ...
        <div class="content-form">
            ...
            <div class="description-other">
                <p class="paragraph-one">Berdasarkan surat pengantar Kepala Lingkungan Desa No : {{ $letter->sk->reference_number }}, Tanggal {{ $letter->sk->created_at->format("d M Y") }}, sepanjang pengetahuan kami bahwa memang benar orang tersebut <strong>Lahir seperti yang tersebut diatas.</strong></p>
