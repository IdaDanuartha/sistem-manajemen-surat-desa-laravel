    ...
    <div class="container">
        ...
        <div class="content-form">
            ...
            <div class="description-other">
                <p class="paragraph-one">Berdasarkan surat pengantar dari Kepala Lingkungan Desa, No: 53/ LD / III / 2022, tanggal 18 Maret 2022, Sepanjang pengetahuan kami bahwa memang benar orang tersebut di atas <strong>{{ $letter->status === 1 ? "Belum Menikah" : "Kawin" }} Sebelum Tanggal {{ $letter->sk->created_at->format("d M Y") }}.</strong></p>
