...
@section('main')
	...
	<div class="table-wrapper mt-[20px] input-teacher">
		<form action="{{ route('letters.sk-subsidized-housing.store') }}" method="post" class="grid grid-cols-12 gap-4" enctype="multipart/form-data">
			@csrf
			...
			<div class="flex col-span-12 justify-between mt-2">
				<div class="flex items-center gap-3">
					...
					<a href="{{ route('letters.sk-subsidized-housing.index') }}" class="button btn-second text-white" type="reset">Batal Tambah</a>
				</div>
			</div>
		</form>
	</div>
