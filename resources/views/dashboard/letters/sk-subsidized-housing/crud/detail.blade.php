...
<x-modal-approve-letter>
	<x-slot name="route">/letters/sk-subsidized-housing/{{ $get_letter->id }}/approve</x-slot>
</x-modal-approve-letter>
<x-modal-reject-letter>
	<x-slot name="route">/letters/sk-subsidized-housing/{{ $get_letter->id }}/reject</x-slot>
</x-modal-reject-letter>
@endsection
