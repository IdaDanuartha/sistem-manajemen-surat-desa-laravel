{{-- Delete Letter --}}
<div class="modal fade" id="deleteSkMarryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-head" id="deleteSkMarryModalTitle">Hapus Surat</h5>
          <button
            type="button"
        ...
        <div class="modal-body">
          <p>
                      ...
                      surat keterangan kawin ini? Tindakan ini tidak dapat dibatalkan dan surat akan
