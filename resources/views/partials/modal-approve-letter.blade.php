{{-- Approve Letter Modal --}}
<div class="modal fade" id="approveLetterModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-head" id="approveLetterModalTitle">Konfirmasi Surat</h5>
        <button
          type="button"
      ...
      <form action="{{ route('letters.sk-birth.approve', $get_letter->id) }}" method="POST" class="d-flex justify-content-center" enctype="multipart/form-data">
        @csrf
        @method("PUT")
