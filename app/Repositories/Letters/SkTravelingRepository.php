...
class SkTravelingRepository
{
  ...
  public function findById(SkTravelingLetter $letter): SkTravelingLetter
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SkTravelingLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SkTravelingLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SkTravelingLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
