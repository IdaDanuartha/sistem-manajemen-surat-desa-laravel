...
class SktuRepository
{
  ...
  public function findById(SktuLetter $letter): SktuLetter
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SktuLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SktuLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SktuLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
