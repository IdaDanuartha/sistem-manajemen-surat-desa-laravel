...
class SkGrantRepository
{
  public function __construct(
    protected readonly Sk $sk,
    protected readonly SkGrantLetter $letter,
  ...
  public function findById(SkGrantLetter $letter): SkGrantLetter
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SkGrantLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SkGrantLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SkGrantLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
