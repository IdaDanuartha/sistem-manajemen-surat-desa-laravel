...
class SkResidenceRepository
{
  public function __construct(
    protected readonly Sk $sk,
    protected readonly SkResidenceLetter $letter,
  ...
  public function findById(SkResidenceLetter $letter): SkResidenceLetter
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SkResidenceLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SkResidenceLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SkResidenceLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
