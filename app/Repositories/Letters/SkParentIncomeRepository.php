...
class SkParentIncomeRepository
{
  public function __construct(
    protected readonly Sk $sk,
    protected readonly SkParentIncomeLetter $letter,
  ...
  public function findById(SkParentIncomeLetter $letter): SkParentIncomeLetter
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SkParentIncomeLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SkParentIncomeLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SkParentIncomeLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
