...
class SkHeirRepository
{
  public function __construct(
    protected readonly Sk $sk,
    protected readonly SkHeir $letter,
  ...
  public function findById(SkHeir $letter): SkHeir
  {
    return $this->letter
      ->where('id', $letter->id)
      ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, SkHeir $letter): bool|array|Exception
  {
    DB::beginTransaction();
  ...
  public function confirmationLetter(SkHeir $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();
    try {
  ...
  public function delete(SkHeir $letter): bool|array|Exception
  {
    DB::beginTransaction();
    try {
