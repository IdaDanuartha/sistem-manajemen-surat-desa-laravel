...
class TreeFellingLetterRepository
{
  public function __construct(
    protected readonly Sk $sk,    
    protected readonly TreeFellingLetter $letter,    
  ...
  public function findById(TreeFellingLetter $letter): TreeFellingLetter
  {
    return $this->letter
                ->where('id', $letter->id)
                ->with(['sk.villageHead', 'sk.environmentalHead', 'sk.sectionHead', 'sk.citizent'])
  ...
  public function update($request, TreeFellingLetter $letter): bool|array|Exception
  {
    DB::beginTransaction();    
  ...
  public function confirmationLetter(TreeFellingLetter $letter, $status, $reject_reason = null): bool|Exception
  {
    DB::beginTransaction();    
    try {  	
  ...
  public function delete(TreeFellingLetter $letter): bool|Array|Exception
  {
    DB::beginTransaction();
    try {           
